...
public class Enemy_Golem : MonoBehaviour
{
    ...
    void Start()
    {
        antiPauseSpam = true; //damit er net veruscht dauerhaft einen rigid hinzuzufügen
        ...
        enemyHp = dataStorage.enemy2Hp;         //Das muss noch für mehrere Enemys erweitert werden!!!
